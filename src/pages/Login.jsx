...
const Login = () => {
  ...
  return (
    <div className="min-h-screen w-[100vw] flex items-center justify-center bg-gray-300 text-black">
      {loading && <Loader />} 
      <div className="w-full flex flex-col items-center p-8 mx-4 max-w-md space-y-4 bg-gray-400 rounded shadow-md">
        <Link to="/" className="">
        ...
        {message && <p className="text-center text-sm text-yellow-700">{message}</p>}
        <form onSubmit={handleSubmit} className="flex flex-col w-full gap-[6px] space-y-4">
          ...
          <button
            type="submit"
            className="bg-indigo-600 hover:bg-indigo-700 transition-colors duration-200 py-2 rounded text-white font-semibold"
          >
            Log In
          </button>
        </form>
